...
def main():
    ...
    output_displacement_file = config["output_displacement_file"]
    output_vonmises_file = config["output_vonmises_file"]
    ...
    analysis_config = {
        ...
        "output_displacement_file": output_displacement_file,
        "output_vonmises_file": output_vonmises_file,
    ...
    print("=" * 70)
    print(f"\nResults saved to: {analysis_config['output_displacement_file']}, {analysis_config['output_vonmises_file']}")
